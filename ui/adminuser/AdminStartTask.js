...
export default function AdminStartTask(props) {
  ...
  return (
    <View style={[{ backgroundColor: theme.colors.background }]}>
      ...
      >
        ...
        >
          <TouchableOpacity
            onPress={() => props.navigation.navigate("TasksAdmin")}
          >
            <Image
        ...
        >
          ...
          <TouchableOpacity
            onPress={() => (pause ? setPause(false) : setPause(true))}
          >
            {pause ? (
              <ImageBackground
                source={require("../../assets/circleblack.png")}
                style={{
                  height: height / 4,
                  width: height / 4,
                  padding: 20,
        ...
        <Surface
          elevation={1}
          style={{
            backgroundColor: pause ? colors.LIGHTGRAY : colors.BLUEBORDER,
            marginVertical: 5,
        ...
        >
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            <View
              style={{
                height: height / 35,
                width: 5,
                backgroundColor: pause ? colors.GRAY : colors.MAIN,
              }}
            ></View>
            <Text
              style={{
          ...
          {pause ? (
            ...
            >
              Paused At: Dec 19, 2023 09:00 AM
            </Text>
          ) : null}
        </Surface>
      </View>
